  ...
  return rows
    ...
    .map((cells) => {
      ...
      return {
        ...
        grossSales: pick(row, ["grosssales", "gross", "sales", "amount", "total", "subtotal"]),
        discounts: pick(row, ["discounts", "discount", "promotions", "promo", "coupons"]),
        tips: pick(row, ["tips", "tip", "gratuity"]),
        tax: pick(row, ["tax", "taxes", "salestax"]),
        fees: pick(row, ["fees", "processingfee", "creditcardfee", "stripefee", "processorfee"]),
        netSales: pick(row, ["netsales", "net", "netamount", "payout", "deposit", "collected"]),
